...
pub unsafe extern "C" fn subsumes(obj: *mut JSPrincipals, other: *mut JSPrincipals) -> bool {
    match (NonNull::new(obj), NonNull::new(other)) {
        ...
        (None, Some(other)) => { warn!("Received null JSPrincipals asrgument. obj: null, other: {:?}. Returning false.", other); false }
        (Some(obj), None) => { warn!("Received null JSPrincipals asrgument. obj: {:?}, other: null. Returning false.", obj); false }
        _ => false
    }    
}
